...
- **x64 only**: SSN extraction supports x86 but the trampoline is x64
- **Single-threaded trampoline**: global atomics race under concurrent syscalls
- **64 slots**: configurable via `ssn::MAX_ENTRIES`